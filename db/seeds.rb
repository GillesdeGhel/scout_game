...
Patrol.create(name: 'Dauphins', troop: archers, money: 200, guild: arbaletrier)
Patrol.create(name: 'Pandas', troop: archers, money: 200, guild: ingenieur)
Patrol.create(name: 'Harfangs', troop: archers, money: 200, guild: constructeur)
Patrol.create(name: 'Hafflingers', troop: archers, money: 200, guild: marchand)
Patrol.create(name: 'Guépards', troop: archers, money: 200, guild: mercenaire)
Patrol.create(name: 'Hérons', troop: archers, money: 200, guild: mineur)
...
Patrol.create(name: 'Huskys', troop: paladins, money: 200, guild: arbaletrier)
Patrol.create(name: 'Lapins', troop: paladins, money: 200, guild: ingenieur)
Patrol.create(name: 'Hirondelles', troop: paladins, money: 200, guild: constructeur)
Patrol.create(name: 'Aurochs', troop: paladins, money: 200, guild: marchand)
Patrol.create(name: 'Alouettes', troop: paladins, money: 200, guild: mercenaire)
Patrol.create(name: 'Jaguars', troop: paladins, money: 200, guild: mineur)
...
Patrol.create(name: 'Léopards', troop: templiers, money: 200, guild: arbaletrier)
Patrol.create(name: 'Seagulls', troop: templiers, money: 200, guild: ingenieur)
Patrol.create(name: 'Otaries', troop: templiers, money: 200, guild: constructeur)
Patrol.create(name: 'Mangoustes', troop: templiers, money: 200, guild: marchand)
Patrol.create(name: 'Gazelles', troop: templiers, money: 200, guild: mercenaire)
Patrol.create(name: 'Furets', troop: templiers, money: 200, guild: mineur)
