...
Patrol.create(name: 'Aigle', troop: hardis, money: 500, guild: arbaletrier)
Patrol.create(name: 'Renard', troop: hardis, money: 500, guild: ingenieur)
Patrol.create(name: 'Cougar', troop: hardis, money: 500, guild: constructeur)
Patrol.create(name: 'Mustang', troop: hardis, money: 500, guild: marchand)
Patrol.create(name: 'Courli', troop: hardis, money: 500, guild: mercenaire)
Patrol.create(name: 'Epervier', troop: hardis, money: 500, guild: mineur)
