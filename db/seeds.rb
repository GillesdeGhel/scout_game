...
servants = Troop.create(name: 'Gilles', country_name: 'Duché de Bourgogne')
...
City.create(name: 'Dijon', troop: servants, defense_building_multiplicator: 1)

archers = Troop.create(name: 'Jerome', country_name: 'Royaume de Navarre')
...
City.create(name: 'Pampelone', troop: archers, defense_building_multiplicator: 1)

paladins = Troop.create(name: 'Brieuc', country_name: 'Royaume d\'Ecosse')
...
City.create(name: 'Edimbourg', troop: paladins, defense_building_multiplicator: 1)
...
# City.create(name: 'Brest', troop: templiers, defense_building_multiplicator: 1)
#
...
# City.create(name: 'Tolede', troop: preux, defense_building_multiplicator: 1)
#
...
# City.create(name: 'Prague', troop: vaillants, defense_building_multiplicator: 1)
#
...
# City.create(name: 'Saragosse', troop: chevaliers, defense_building_multiplicator: 1)
#
...
# City.create(name: 'Genes', troop: hardis, defense_building_multiplicator: 1)
#
...
# City.create(name: 'Bruges', troop: gueux, defense_building_multiplicator: 1)

City.create(name: 'Paris', defense_building_multiplicator: 1)
